...
// 결괴값 : (6) ['김일', '김이', '김삼', '김사', '김오', '김육']

let students = myStudents.slice(2);
console.log(students);
// 결과값 : (4) ['김삼', '김사', '김오', '김육']
let students2 = myStudents.slice(3, 6);
...
// filter()
/*
  filter() 메서드를 활용해 words 배열 내에 있는 단어의 길이가 6 이상인 것들만 추출해 새로운 배열을 만들어 console에 출력하기
*/
...
/*
  점수가 80점 이상인 사람만 가지고 새로운 배열을 작성
*/
